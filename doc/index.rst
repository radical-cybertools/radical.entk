...
Ensemble Toolkit is released under the `MIT License
<http://opensource.org/licenses/MIT>`_. More details and the reference to cite 
Ensemble Toolkit can be found at http://arxiv.org/abs/1602.00678 (accepted in 
ICPP 2016).
