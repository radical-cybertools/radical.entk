...
from radical.entk.exceptions import ArgumentError
from radical.entk.exceptions import NoKernelConfigurationError
...
# ------------------------------------------------------------------------------
# 
class mkfile_kernel(KernelBase):
    ...
    def __init__(self):
        """Le constructor.
        """
        super(mkfile_kernel, self).__init__(_KERNEL_INFO)
