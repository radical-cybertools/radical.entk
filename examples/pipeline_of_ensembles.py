...
__license__      = "MIT"
__example_name__ = "A Pipeline of Ensemblees"
...
if __name__ == "__main__":
    ...
    try:
        ...
        # Create a new ensemble preprocessing step: generate 16 10MB ASCII files.
        pre = Ensemble(size=BATCH_SIZE)
        ...
        # Create a new ensemble processing step: count the character frequencies. 
        proc = Ensemble(size=BATCH_SIZE)
        ...
        # Add all three ensemble steps to the pipeline for sequential execution.
        pipeline = Pipeline()
