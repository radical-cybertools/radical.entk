...
if __name__ == "__main__":
    ...
    try:
        ...
        print "Simulation performed {0} cycles for {1} replicas, so in your working directory you should".format(re_pattern.nr_cycles, re_pattern.replicas)
        print "have {0} md_input_x_y.md files and {0} md_input_x_y.out files where x in {{0,1,2,...{1} }} and y in {{0,1,...{2} }}.".format( (re_pattern.nr_cycles*re_pattern.replicas), (re_pattern.replicas-1), re_pattern.nr_cycles)
