...
if __name__ == '__main__':
    ...
    Enmd32cores10DataFrame.append(pandas.read_pickle('results_400_32cores10win_stampede_2015-04-22T23:16:25.715003.pkl'))
    ...
    enmd40 = ((Enmd32cores40DataFrame[0].last_finished_abs[2] - Enmd32cores40DataFrame[0].first_started_abs[2]).total_seconds() + 
              (Enmd32cores40DataFrame[1].last_finished_abs[2] - Enmd32cores40DataFrame[1].first_started_abs[2]).total_seconds())/2
    ...
    pilot10 = pilot10 + read_logfiles('output_400_10_traj_stampede_32cores_2015-04-22T22:27:18.190919.log')
    pilot20 = 0
