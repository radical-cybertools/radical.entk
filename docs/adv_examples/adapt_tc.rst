...
You can download the complete code discussed in this section :download:`here <../../examples/advanced_examples/adapt_tc.py>` or
find it in your virtualenv under ``share/radical.entk/advanced_examples/scripts``.
...
.. literalinclude:: ../../examples/advanced_examples/adapt_tc.py
