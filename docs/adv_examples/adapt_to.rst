...
You can download the complete code discussed in this section :download:`here <../../examples/advanced_examples/adapt_to.py>` or
...
.. literalinclude:: ../../examples/advanced_examples/adapt_to.py
