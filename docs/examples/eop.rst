...
You can download the complete code discussed in this section :download:`here <../../examples/simple_examples/eop.py>` or find it in 
...
.. literalinclude:: ../../examples/simple_examples/eop.py