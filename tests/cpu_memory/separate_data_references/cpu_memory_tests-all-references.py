...
def create_single_task_reference():

    return ru.generate_id('ref')

def create_single_stage(tasks):

    stage = frozenset([create_single_task_reference() for _ in range(tasks)])
    return stage
...
if __name__ == '__main__':
    ...
    f = open('separate_data_references/monitor_stage_variation.csv','w')
