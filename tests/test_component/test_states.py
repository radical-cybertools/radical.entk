...
class TestBase(TestCase):
    ...
    def test_states_list(self):
        ...
        self.assertEqual(states.FINAL, [states.DONE, states.FAILED, states.CANCELED])


    def test_state_numeric_vals(self):

        self.assertEqual(states.state_numbers, {states.INITIAL: 1,
                                        states.SCHEDULING: 2,
                                        states.SUSPENDED: 3,
                                        states.SCHEDULED: 4,
                                        states.SUBMITTING: 5,
    ...
    def test_pipeline_states(self):
        ...
        self.assertEqual(states._pipeline_state_values, {states.INITIAL: 1,
                                                states.SCHEDULING: 2,
                                                states.SUSPENDED: 3,
                                                states.DONE: 10,
                                                states.FAILED: 10,
        ...
        self.assertEqual(states._pipeline_state_inv, {1: states.INITIAL,
                                            2: states.SCHEDULING,
                                            3: states.SUSPENDED,
    ...
    def test_stage_states(self):
        ...
        self.assertEqual(states._stage_state_values, {states.INITIAL: 1,
                                            states.SCHEDULING: 2,
                                            states.SCHEDULED: 4,
                                            states.DONE: 10,
                                            states.FAILED: 10,
        ...
        self.assertEqual(states._stage_state_inv, {1: states.INITIAL,
                                        2: states.SCHEDULING,
                                        4: states.SCHEDULED,
                                        10: [states.DONE, states.FAILED,
                                            states.CANCELED]
